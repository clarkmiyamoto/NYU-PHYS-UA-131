...
\begin{problem}[$\star$ Charge Distributions]
	The total charge $Q$ is related to the charge distribution $\rho(\mathbf r)$ by $Q = \int \rho(\mathbf r) d^3 r$. What are 
$\rho(\mathbf r)$ for the following systems?
	\begin{itemize}
		\item Point charge w/ total charge $Q$. Do this in cartesian coordinates $(x,y,z)$, cylindrical coordinates $(\rho, \phi, z)$, and finally in spherical coordinates $(r, \phi, \theta)$.
